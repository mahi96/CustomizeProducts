...
<script type="text/javascript">
    ...
    document.getElementById("0").style.position="relative";
...
<div id="inner">
	<nav>
		...
		<li><a href="tsh.html">T Shirts</a></li>
		<li><a href="mob.html">Mobile Cases</a></li>
		<li><a href="cush.html">Cushions</a></li>
...
<div id="main">
    ...
    <input type="button" value="Cancel" onclick="index.html"></input>
